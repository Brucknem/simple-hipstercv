...
\simpleheader{headercolour}{Marcel}{Bruckner}{Software Consultant}{white}
...
\begin{paracol}{2}
    ...
    \flushright
    \begin{center}
        \roundpic{marcel_square_small_cropped.jpg}
        % \roundpic{marcel_square_small.jpg}
    \end{center}
    ...
    \infobubble{\faAt}{cvgreen}{white}{mbruckner94@gmail.com}
    \infobubble{\faFacebook}{cvgreen}{white}{Marcel Bruckner}
    \infobubble{\faGithub}{cvgreen}{white}{brucknem}
